...
int main()
{
    ...
    std::string logo_image_file("/home/rohit/Downloads/projection/images/logos/gt-logo-gold.jpg");
    cv::Mat logo_image;
    ...
    for(int i=1; i<=129; i++)
    {
        sprintf(buffer, "/home/rohit/Downloads/projection/images/barcaReal/BarcaReal%03d.jpg", i);
    ...
    std::string filename = "/home/rohit/Downloads/projection/data/video_pts.csv";
    ...
    for(int i=0; i<count; i++)
    {
        ...
        char buffer[100];
        sprintf(buffer, "/home/rohit/Downloads/projection/images/wrapped_images/gt_image%03d.jpg", i);
